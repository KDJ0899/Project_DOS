...
import com.dos.game.VolumeBoard;
import com.dos.image.ImageParser;
import com.dos.item.Item;
import com.dos.login.LoginSession;
import com.dos.main.MultiThreadClient;
	...
	private void startBtnClick(int i) {
		...
		try {
			if (LobbyView.mod.equals("Single") && LobbyView.mode_voice.equals("voice")) {
				...
				AnchorPane pane = FXMLLoader.load(Class.forName("com.dos.main.MultiThreadClient").getResource("/view/GameScreen.fxml"));
				...
				AnchorPane pane = FXMLLoader.load(Class.forName("com.dos.main.MultiThreadClient").getResource("/view/MultiScreen.fxml"));
