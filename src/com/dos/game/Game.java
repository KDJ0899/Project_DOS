package com.dos.game;

import java.util.ArrayList;

import com.dos.image.ImageStorage;
import com.dos.lobby.LobbyView;
import com.dos.lobby.Menubar;
...
public class Game extends Thread {
	...
	public static void pause() {
		Task<Void> task = new Task<Void>() {
			public Void call() throws Exception {
				...
				Platform.runLater(() -> {
					try {
						AnchorPane second = FXMLLoader.load(Class.forName("com.dos.main.MultiThreadClient").getResource("/view/PopupPause.fxml"));
	...
	private static void moveHome() {
		...
		try {
			...
			AnchorPane second = FXMLLoader.load(Class.forName("com.dos.main.MultiThreadClient").getResource("/view/SelectScreen.fxml"));
