...
public class DOSApplication extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
		try {
			...
			Font f = Font.loadFont(Class.forName("com.dos.main.DOSApplication").getResourceAsStream("/images/210 옴니고딕020.ttf"), 50);
			Scene scene = new Scene(root);
			scene.getStylesheets().add(DOSApplication.class.getResource("/com/application.css").toExternalForm());
